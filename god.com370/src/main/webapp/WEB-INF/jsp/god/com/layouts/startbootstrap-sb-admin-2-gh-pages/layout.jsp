            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=god/com/EgovPageLink/NewFile"><i class="fa fa-dashboard fa-fw"></i> 테스트</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=god/com/EgovPageLink/NewFile2"><i class="fa fa-dashboard fa-fw"></i> 테스트2</a>
                        </li>
                        <li>
                            <a href="${pageContext.request.contextPath}/EgovPageLink.do?link=god/com/EgovPageLink/sub1/NewFile"><i class="fa fa-dashboard fa-fw"></i> sub1 테스트</a>
                        </li>
                        <li>
